...
namespace CursoMvc.Data
{
    public  class SeedingService
    {
        ...
        private CursoMvcContext _context;

        public SeedingService(CursoMvcContext context)
        {
            _context = context;
        }   
        ...
        public void Seed()
        {
            ...
            Funcionario s1 = new Funcionario(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Funcionario s2 = new Funcionario(2, "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 3500.0, d2);
            Funcionario s3 = new Funcionario(3, "Alex Grey", "alex@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
            Funcionario s4 = new Funcionario(4, "Martha Red", "martha@gmail.com", new DateTime(1993, 11, 30), 3000.0, d4);
            Funcionario s5 = new Funcionario(5, "Donald Blue", "donald@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3);
            Funcionario s6 = new Funcionario(6, "Alex Pink", "bob@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);
            ...
            RegistroVendas r27 = new RegistroVendas(27, new DateTime(2018, 10, 13), 9000.0, StatusVendas.Faturado, s1);
